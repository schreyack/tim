...
_build_full_review_prompt() {
    ...
    prompt+="- Read plan and subplan files directly — they must be in context for editing\n"
    prompt+="- Delegate ALL codebase verification to Explore subagents\n"
    prompt+="- Cap each subagent: 'Report only findings relevant to the plan. Response under 2000 characters. No file contents.'\n"
    prompt+="- Do NOT read codebase source files directly into the main context\n"
