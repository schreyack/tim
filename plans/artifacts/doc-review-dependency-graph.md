...
| `README.md` | `libs/python/README.md`, `libs/node/README.md`, `marketplace/plugins/tim-loop/README.md`, `templates/README.md`, `examples/python/`, `examples/node/`, `tools/tim-compliance-check.sh` |
...
| `templates/tim-patterns.yaml.template` | `standards/security/authentication.md`, `standards/coding/python.md`, `standards/coding/api-versioning.md`, `standards/deployment/observability.md` |
...
| Source File | References To |
|-------------|--------------|
| `tools/APPROVAL-QUICK-REFERENCE.md` | `standards/enforcement/ai-developer-ready-checklist.md`, `standards/operations/plan-management.md`, `bin/plan-ops` |

---

*Last updated: Phase 7 - all stale references resolved, dependency graph verified.*
